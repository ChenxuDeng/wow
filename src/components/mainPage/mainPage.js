                    ...
                    <div className={classes.contentBackground}>
                        <div className={classes.content}>
                            <Container maxWidth={'md'} style={{padding:'0'}}>
                                ...
                                <Button className={classes.contentDetail}
                                ...
                                <div className={classes.bottomBackground}>
                                    <div className={classes.subscribeStyle}>
                                        <div className={classes.subscribe}>
                                            关注魔兽
                                        </div>
                                        <div className={classes.subscribeIcons}>
                                ...
                                <div style={{marginTop:'240px',textAlign:'center'}}>
                                    ...
                                    <div className={classes.bottomText} style={{marginTop:'10px'}}>
                                    ...
                                    <div className={classes.bottomText} style={{marginTop:'6px'}}>
